...
module.exports.run = async (bot, message, args) => {//exportando o comando como ship
  ...
  if(!membro1 || !membro2) return message.channel.send('Você precisa mencionar 2 usuários para poder shippa-los!')
    if(membro1 === membro2) return message.channel.send('Você não pode shippar uma pessoa com ela mesma!')
