...
if(!(await donos.includes(message.author.id))) return message.channel.send('só pessoas de confiança podem usar este comando');
        let code = args.join(' ')
...
if(code.includes('exit')) return message.reply('Ta tirando menor?'); 
